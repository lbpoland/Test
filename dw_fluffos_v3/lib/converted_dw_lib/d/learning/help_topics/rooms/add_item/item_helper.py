# Generated from /mnt/home2/test/Test/dw_fluffos_v3/lib/d/learning/help_topics/rooms/add_item/item_helper.c (2003 FluffOS v3) for Forgotten Realms MUD
...
import asyncio
    ...
    def setup(self, ) -> None:
            ...
            ,"set"      ,({self,"do_set","%D 'pattern' 'to' %s"]
            ,"name"     ,({self,"do_name","%D 'verb' 'to' %s"]
            ,"query"    ,"@@do_query:"+file_name(self)+"@@\n"
            ,"add"      ,({self,"do_add","'an' %D 'named' %s"]
            }))


    def do_set(self, a1: Any, a2: Any, a3: Any, a4: Any, a5: Any, a6: Any) -> int:
            {
            pattern = (string) a5[1]
            return 1


    def do_name(self, a1: Any, a2: Any, a3: Any, a4: Any, a5: Any, a6: Any) -> int:
            {
            verb = (string) a5[1]
            return 1


    def do_add(self, a1: Any, a2: Any, a3: Any, a4: Any, a5: Any, a6: Any) -> int:
            {
            object *obs
            add_item( a5[1]
            ,({
            ...
            +":\nAnd verb:"+verb+":\n\n"
            ,verb      ,({self,"do_use",pattern]
            }))
            obs = all_inventory(self)
            obs.move("/room/void")
            obs.move(self)
            this_player()->move(self)
            return 1


    def do_use(self, a1: Any, a2: Any, a3: Any, a4: Any, a5: Any, a6: Any) -> int:
            {
            printf("\nThe Verb:(A1):  %O\nThe Objects(A2):\n%O\nDirect Object(A3):  %O\nIndirect Object(A4):  %O\nReturn Array(A5):\n%O\nPattern(A6):  %O\n\n",a1,a2,a3,a4,a5,a6)
            await this_player().send("Hope that worked...\n")
            return 1



class Item_helper(Room):
