# Generated from /mnt/home2/test/Test/dw_fluffos_v3/lib/d/learning/help_topics/rooms/add_item/changing_descs.c (2003 FluffOS v3) for Forgotten Realms MUD
...
import asyncio
    ...
    def look_chest(self, ) -> str:
            if(open) { open = 0; return "Open."; }
            open = 1; return "Closed!"



class Changing_descs(Room):
