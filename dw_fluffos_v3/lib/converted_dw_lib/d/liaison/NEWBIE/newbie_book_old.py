# Generated from /mnt/home2/test/Test/dw_fluffos_v3/lib/d/liaison/NEWBIE/newbie_book_old.c (2003 FluffOS v3) for Forgotten Realms MUD
...
import asyncio
    ...
    def setup(self, ) -> None:
            ...
            " See Gennie Applebottom at Dione Street in Waterdeep if you have \n"
            ...
            " '%^B_RED%^help map%^RESET%^'  will give you a nice map of Faerûnworld and "
            "there are more \n"
...
class Newbie_book_old(MudObject):
