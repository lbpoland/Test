# Generated from /mnt/home2/test/Test/dw_fluffos_v3/lib/d/liaison/NEWBIE/help.c (2003 FluffOS v3) for Forgotten Realms MUD
...
import asyncio
    ...
    def setup(self, ) -> None:
            ...
            FOYER->format_sign(
            "The Faerûnworld help system is divided into two parts: "
            ...
            "leave the newbie area to enter Faerûnworld proper.  "
            "Before reaching the Faerûn, you'll be given the choice of "
            ...
            FOYER->format_sign(
            "Faerûnworld is a very friendly mud and there are "
            ...
            FOYER->format_sign(
            "To leave Faerûnworld at any time, "
