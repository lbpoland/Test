# Generated from /mnt/home2/test/Test/dw_fluffos_v3/lib/d/liaison/NEWBIE/advancement.c (2003 FluffOS v3) for Forgotten Realms MUD
...
import asyncio
    ...
    def setup(self, ) -> None:
            ...
            "handle.  "
            "Several overstuffed sofas have been partyed in the centre "
            ...
            "twisted mass of spun octiron, the magical metal of Faerûnworld.")
            ...
            "'statistics', 'classpoints', 'hitpoints', "
            "'skills' and 'advancement'.\n",
            "read", "There are many of these pinned to the walls of the "
            "room.  Several catch your eye including ones marked "
            "'statistics', 'classpoints', 'hitpoints', "
            "'skills' and 'advancement'.\n"}))
            add_item("sofa", ({"long", "Several well-stuffed and well-donned in Faerûn sofas with "
            ...
            "On Faerûnworld your skill bonus typically determines your "
            ...
            "Once you enter Faerûnworld, you may rearrange your stats.  "
            ...
            "chosen a class and have asked other class members for "
            ...
            "Skills can be advanced in a variety of ways on Faerûnworld.  "
            "The class you join will allow you to advance your skills "
            "for a certain number of experience points and a small fee.  "
            "When you reach the proper skill level your class will "
