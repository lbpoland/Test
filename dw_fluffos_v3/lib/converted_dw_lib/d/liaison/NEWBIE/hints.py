# Generated from /mnt/home2/test/Test/dw_fluffos_v3/lib/d/liaison/NEWBIE/hints.c (2003 FluffOS v3) for Forgotten Realms MUD
...
import asyncio
    ...
    def setup(self, ) -> None:
            ...
            FOYER->format_sign(
            "Combat is a fairly important part of Faerûnworld.  The combat "
            ...
            FOYER->format_sign(
            "At some point you will inevitably end up dying on Faerûnworld, but "
    ...
    def do_search(self, ) -> int:
            ...
            await this_player().send("You pick up the brooch.\n")
