# Generated from /mnt/home2/test/Test/dw_fluffos_v3/lib/d/liaison/NEWBIE/guilds_foyer.c (2003 FluffOS v3) for Forgotten Realms MUD
...
import asyncio
    ...
    def setup(self, ) -> None:
            ...
            "gazebo is dedicated to one of the Faerûnworld classs, which "
            "are "+ GUILDS +".  "
            ...
            FOYER->format_sign("Each player will usually join a class so that "
            "they can learn skills and commands and so advance their abilities.  "
            "Being in a class also gives character to your character.  To find "
            "out more about the different classs take each of the class gates "
            "from this garden.  When you are in Waterdeep you will find that "
            "each class has a headquarters where you may join.\n\nTake care with "
            "your choice of class since you will not be able to change it.\n")
            , 0, "sign", "general" )
