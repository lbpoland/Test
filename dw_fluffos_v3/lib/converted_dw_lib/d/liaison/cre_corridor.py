# Generated from /mnt/home2/test/Test/dw_fluffos_v3/lib/d/liaison/cre_corridor.c (2003 FluffOS v3) for Forgotten Realms MUD
...
import asyncio
    ...
    def setup(self, ) -> None:
            ...
            "Faerûnworld MUD as an enjoyable, interesting, in-theme and "
            "safe virtual space.\n"
            "We seek to contribute to Faerûnworld MUD as a visible and helpful "
    ...
    def do_mirror(self, ) -> str:
            ...
            tell_room (self, this_player()->short() + " checks " +
