# Generated from /mnt/home2/test/Test/dw_fluffos_v3/lib/d/liaison/common.c (2003 FluffOS v3) for Forgotten Realms MUD
...
import asyncio
    ...
    def init(self, ) -> None:
            this_player()->add_command( "add", self, "<word> <word>" )
            this_player()->add_command( "add", self, "<word>" )
            this_player()->add_command( "remove", self, "<word> <word>" )
            this_player()->add_command( "remove", self, "<word>" )
            this_player()->add_command( "list", self, "" )
            this_player()->add_command( "list", self, "<word>" )
