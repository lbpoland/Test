# Generated from /mnt/home2/test/Test/dw_fluffos_v3/lib/d/dist/pumpkin/rabbit/print_shop_binding.c (2003 FluffOS v3) for Forgotten Realms MUD
...
import asyncio
    ...
    def is_room_open(self, ) -> int:
            return 1



class Print_shop_binding(MudObject):
