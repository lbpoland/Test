# Generated from /mnt/home2/test/Test/dw_fluffos_v3/lib/d/dist/pumpkin/rabbit/print_shop_office.c (2003 FluffOS v3) for Forgotten Realms MUD
...
import asyncio
    ...
    def reset(self, ) -> None:
            ...
            goatberger.move(self, "$N arrives from the west.\n")
            goatberger.return_to_default_position(0)


    def is_office_open(self, obs: MudObject) -> int:
            if (!goatberger) {
...
class Print_shop_office(MudObject):
