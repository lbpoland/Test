# Generated from /mnt/home2/test/Test/dw_fluffos_v3/lib/d/dist/pumpkin/chars/child_human.c (2003 FluffOS v3) for Forgotten Realms MUD
...
import asyncio
    ...
    def respond_to_soul(self, play: MudObject) -> None:
            switch (random(6)) {
            case 0:
