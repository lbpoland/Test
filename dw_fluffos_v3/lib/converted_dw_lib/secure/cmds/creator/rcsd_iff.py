# Generated from /mnt/home2/test/Test/dw_fluffos_v3/lib/secure/cmds/creator/rcsd_iff.c (2003 FluffOS v3) for Forgotten Realms MUD
...
import asyncio
    ...
    def write_call_back(self, fd: int) -> None:
            await TP.send("rcsdiff: Whoops! fatal error.\n")
    ...
    def close_call_back(self, fd: int) -> None:
            ...
            await TP.send("rcsdiff completed.\n")
            map_delete(ret, fd)
            map_delete(globals, fd)



class Rcsd_iff(MudObject):
